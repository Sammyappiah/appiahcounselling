        ...
        <div className="max-w-[1200px]">
          ...
          <div className="flex flex-wrap gap-4 mt-14">
            ...
            <Link
              ...
              target="_blank"
              className="inline-flex items-center justify-center h-[58px] px-10 rounded-full border border-[#d7cdc1] text-[#171412] tracking-[0.22em] text-[0.78rem]"
            >
              SPOTIFY
            </Link>
            ...
            <Link
              ...
              className="inline-flex items-center justify-center h-[58px] px-10 rounded-full bg-[#d4a24c] text-[#171412] tracking-[0.22em] text-[0.78rem]"
            >
              APPLE PODCASTS
            </Link>
