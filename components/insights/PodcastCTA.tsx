...
export default function PodcastCTA() {
  return (
    <section className="py-12 border-t border-[#e3d8cb]">
      ...
      <div className="max-w-[1240px] mx-auto px-6 md:px-8 lg:px-16">
        ...
        <div className="grid lg:grid-cols-[340px_1fr] gap-14 items-center">
          ...
          <div className="aspect-square rounded-[28px] overflow-hidden bg-gradient-to-br from-[#efe6d8] via-[#f6eee4] to-[#d7ba84]">
          ...
          <div>
            ...
            <p className="mt-8 max-w-[58ch] text-[1rem] leading-8 text-[#5c5550]">
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              ...
              <Link
                ...
                target="_blank"
                className="inline-flex items-center justify-center h-[50px] px-8 rounded-full bg-[#171412] text-white text-[0.72rem] uppercase tracking-[0.22em]"
              >
                Spotify
              </Link>
              ...
              <Link
                ...
                target="_blank"
                className="inline-flex items-center justify-center h-[50px] px-8 rounded-full border border-[#ddd3c7] text-[#171412] text-[0.72rem] uppercase tracking-[0.22em]"
              >
                Apple Podcasts
              </Link>
